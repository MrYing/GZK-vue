...
* @returns {string}
*/
function doGetMsg_50( intPageIndex, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':50," +
...
* @returns {string}
*/
function doGetMsg_54( dateSettingTime, intFocusType, intFromAreaID, intPageIndex, intQueryGoodsInfoListTypes, intQueryListTypes, intToAreaID, strSearchContent, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':54," +
...
/**
 * 消息 56
 * GZKMsg_56_complaint_information
 * 投诉信息
 * 真实数据（新增加）
 * @param intTalkAboutType 投诉分类 0:默认未知；1:假信息；2：骚扰；3：非法；999:其他
 * @param strContactPhone 联系电话
 * @param strInfoSysID  关联信息记录系统编号
 * @param strPublishUserSysID  发布人用户系统编号
 * @param strRemark 备注留言 100 字
 * @returns {string}
 */
function doGetMsg_56( intTalkAboutType, strContactPhone, strInfoSysID, strPublishUserSysID, strRemark) {
    return "{'GZKMSG':[{" +
        "'intMsgID':56," +
        "'intTalkAboutType':" + intTalkAboutType + "," +
...
* @returns {string}
*/
function doGetMsg_60( floatCarLength, floatCarWeight, intAutoRePublish, intAutoRePublishTime, intCarType, intFromAreaID, intToAreaID, strContactPhone, strOtherContactPhone, strOtherToAreaDesc, strPublishUserSysID, strRemark, strUserName) {
   return "{'GZKMSG':[{" +
       "'intMsgID':60," +
       "'floatCarLength':" + floatCarLength + "," + 
       "'floatCarWeight':" + floatCarWeight + "," + 
...
* @returns {string}
*/
function doGetMsg_64( intHistory, intPageIndex, strContactPhone, strPublishUserSysID, strSearchContent, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':64," +
...
* @returns {string}
*/
function doGetMsg_66( strInfoSysID, strInvalidUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':66," +
       "'strInfoSysID':'" + strInfoSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_70( strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':70," +
       "'strInfoSysID':'" + strInfoSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_72( strCancelUserSysID, strContactPhone, strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':72," +
...
* @returns {string}
*/
function doGetMsg_74( dateUpdate, strCancelUserSysID, strContactPhone, strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':74," +
 ...
 * @returns {string}
 */
function doGetMsg_78( intPageIndex, strSearchContent, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':78," +
        "'intPageIndex':" + intPageIndex + "," +
        "'strSearchContent':'" + strSearchContent + "'," +
 ...
 * @returns {string}
 */
function doGetMsg_80( intPageIndex, strSearchContent, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':80," +
        "'intPageIndex':" + intPageIndex + "," +
        "'strSearchContent':'" + strSearchContent + "'," +
...
* @returns {string}
*/
function doGetMsg_86( strCarSysID, strCompanySysID, strDriverUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':86," +
...
* @returns {string}
*/
function doGetMsg_88( strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':88," +
       "'strInfoSysID':'" + strInfoSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_90( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':90," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_100( floatGPSLat, floatGPSLng, intClientVerNum, intDeviceOSType) {
   return "{'GZKMSG':[{" +
       "'intMsgID':100," +
...
* @returns {string}
*/
function doGetMsg_102( floatGPSLat, floatGPSLng, intClientVerNum, intDeviceOSType) {
   return "{'GZKMSG':[{" +
       "'intMsgID':102," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_110( floatGPSLat, floatGPSLng, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':110," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_112( floatGPSLat, floatGPSLng, intQueryLevel, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':112," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_114( A, B, C, D, E) {
   return "{'GZKMSG':[{" +
       "'intMsgID':114," +
       "'A':'" + A + "'," + 
       "'B':" + B + "," + 
...
* @returns {string}
*/
function doGetMsg_120( intSendSMSType, strPhoneNumber, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':120," +
...
* @returns {string}
*/
function doGetMsg_122( intHotListType) {
   return "{'GZKMSG':[{" +
       "'intMsgID':122," +
...
* @returns {string}
*/
function doGetMsg_130( intDetailArray) {
   return "{'GZKMSG':[{" +
       "'intMsgID':130," +
...
* @returns {string}
*/
function doGetMsg_134( intPageIndex, intQueryType, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':134," +
       "'intPageIndex':" + intPageIndex + "," + 
...
* @returns {string}
*/
function doGetMsg_136( intPageIndex, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':136," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_138( intAutoID, intCareType, intFromAreaID, intOperateType, intToAreaID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':138," +
       "'intAutoID':" + intAutoID + "," + 
...
* @returns {string}
*/
function doGetMsg_140( intMapLevel) {
   return "{'GZKMSG':[{" +
       "'intMsgID':140," +
...
* @returns {string}
*/
function doGetMsg_142( intDaysBefore, intPageIndex) {
   return "{'GZKMSG':[{" +
       "'intMsgID':142," +
...
* @returns {string}
*/
function doGetMsg_144( intFromAreaID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':144," +
       "'intFromAreaID':" + intFromAreaID + "," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_200( intUploadReason, intUploadType, strSourceID, strUploadValue) {
    var strTemp = "{'GZKMSG':[{" +
        "'intMsgID':200," +
...
* @returns {string}
*/
function doGetMsg_230( strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':230," +
       "'strInfoSysID':'" + strInfoSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_232( floatPriceAll, strAutoIDList, strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':232," +
...
* @returns {string}
*/
function doGetMsg_234( strAutoIDList, strInfoSysID, strPayOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':234," +
       "'strAutoIDList':'" + strAutoIDList + "'," + 
       "'strInfoSysID':'" + strInfoSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_236( strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':236," +
       "'strInfoSysID':'" + strInfoSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_238( intPageIndex, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':238," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_240( strCancelInfoSysID, strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':240," +
...
* @returns {string}
*/
function doGetMsg_242( intPageIndex, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':242," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_250( intPageCount, intPageIndex, intQueryType, strPhoneGroupPhone) {
   return "{'GZKMSG':[{" +
       "'intMsgID':250," +
...
* @returns {string}
*/
function doGetMsg_252( intOptionType, strPhoenGroupDesc, strPhoenGroupMaster, strPhoneContactName, strPhoneGroupAlias, strPhoneGroupOther) {
   return "{'GZKMSG':[{" +
       "'intMsgID':252," +
...
* @returns {string}
*/
function doGetMsg_260( floatIntervalPrice1, floatIntervalPrice2, floatIntervalPrice3, floatMsgCost, intCarriageType, intInsureStatus, intOrderInfoStatus, intOrderRange, strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':260," +
...
* @returns {string}
*/
function doGetMsg_262( intPageIndex, intQueryStatus, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':262," +
       "'intPageIndex':" + intPageIndex + "," + 
...
* @returns {string}
*/
function doGetMsg_264( strInfoRoundOrderSysID, strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':264," +
...
* @returns {string}
*/
function doGetMsg_266( floatGPSLat, floatGPSLng, floatIntervalPrice, floatMsgCost, floatQuotation, intCarriageType, strInfoRoundOrderSysID, strInfoSysID, strQueueAgainPayOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':266," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_268( strInfoRoundOrderSysID, strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':268," +
       "'strInfoRoundOrderSysID':'" + strInfoRoundOrderSysID + "'," + 
       "'strInfoSysID':'" + strInfoSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_270( strQueueSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':270," +
...
* @returns {string}
*/
function doGetMsg_272( strInfoRoundOrderSysID, strInfoSysID, strQueueSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':272," +
       "'strInfoRoundOrderSysID':'" + strInfoRoundOrderSysID + "'," + 
       "'strInfoSysID':'" + strInfoSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_274( strInfoRoundOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':274," +
       "'strInfoRoundOrderSysID':'" + strInfoRoundOrderSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_276( intAssistanceType, strAssistanceContent, strInfoRoundOrderSysID, strPhoneNumber, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':276," +
...
* @returns {string}
*/
function doGetMsg_278( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':278," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_280( intOperateType, strAssistanSysID, strAssistanceRefuseReason, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':280," +
       "'intOperateType':" + intOperateType + "," + 
...
* @returns {string}
*/
function doGetMsg_282( strAssistanSysID, strInfoRoundOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':282," +
       "'strAssistanSysID':'" + strAssistanSysID + "'," + 
       "'strInfoRoundOrderSysID':'" + strInfoRoundOrderSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_300( floatGPSLat, floatGPSLng, strUserPasscode, strUserPhoneNumber) {
   return "{'GZKMSG':[{" +
       "'intMsgID':300," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_302( floatGPSLat, floatGPSLng, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':302," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_304( floatGPSLat, floatGPSLng, intUserIdentityType, strInvitationPhoneNumber, strSMSCode, strUserPasscode, strUserPhoneNumber) {
   return "{'GZKMSG':[{" +
       "'intMsgID':304," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_306( floatGPSLat, floatGPSLng, intResetReason, strPhoneNumber, strSMSCode, strUserPasscode) {
   return "{'GZKMSG':[{" +
       "'intMsgID':306," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_310( strQueryUserSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':310," +
...
* @returns {string}
*/
function doGetMsg_312( strQueryUserSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':312," +
       "'strQueryUserSysID':'" + strQueryUserSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_318( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':318," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_324( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':324," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_326( intAutoID, intDataStatus, intOperateType, strDataContent, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':326," +
       "'intAutoID':" + intAutoID + "," + 
...
* @returns {string}
*/
function doGetMsg_330( intPlaceResidence, strAddress, strRelativesName, strRelativesPhone, strUserAlias, strUserHeadResID, strUserName, strUserRemark, strUserSignatureRsID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':330," +
...
* @returns {string}
*/
function doGetMsg_334( strUserIDCardNumber, strUserIDCardRsID, strUserName, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':334," +
...
* @returns {string}
*/
function doGetMsg_336( intUserCurrentStatus, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':336," +
...
* @returns {string}
*/
function doGetMsg_350( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':350," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_352( intCompanyCreateYear, strCompanyAddress, strCompanyIDCardRSID, strCompanyIconRSID, strCompanyName, strCompanyOperatingRSID, strCompanyPhotoRSID1, strCompanyPhotoRSID2, strCompanyPhotoRSID3, strCompanyRemark, strCompanySysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':352," +
...
* @returns {string}
*/
function doGetMsg_354( strCompanyAuthRsID, strCompanyIDCardRSID, strCompanyName, strCompanySysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':354," +
...
* @returns {string}
*/
function doGetMsg_360( intPageIndex, strCarPlateNumber, strCompanySysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':360," +
       "'intPageIndex':" + intPageIndex + "," + 
...
* @returns {string}
*/
function doGetMsg_362( strCarSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':362," +
       "'strCarSysID':'" + strCarSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_366( intCarBuyYear, strCarLicenseRSID, strCarLicenseRSID2, strCarPlateNumber, strCarSysID, strEngineNumber, strTrailerVehicleLicenseRSID, strTrailerVehicleLicenseRSID2, strVehicle) {
   return "{'GZKMSG':[{" +
       "'intMsgID':366," +
       "'intCarBuyYear':" + intCarBuyYear + "," + 
       "'strCarLicenseRSID':'" + strCarLicenseRSID + "'," + 
...
* @returns {string}
*/
function doGetMsg_368( strCarSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':368," +
       "'strCarSysID':'" + strCarSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_370( strDriverSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':370," +
...
* @returns {string}
*/
function doGetMsg_372( strCarSysID, strCompanySysID, strDriverLicenseID, strDriverLicenseRSID, strDriverName, strDriverPhoneNumber, strDriverPhotoRSID, strDriverSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':372," +
       "'strCarSysID':'" + strCarSysID + "'," + 
       "'strCompanySysID':'" + strCompanySysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_380( intPageIndex, strFromUserSysID, strOrderSysID, strToUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':380," +
       "'intPageIndex':" + intPageIndex + "," + 
...
* @returns {string}
*/
function doGetMsg_382( strOrderSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':382," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_384( strAboutOrderSysID, strEvalDesc, strEvalFromUserSysID, strEvalLabelID, strEvalToUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':384," +
...
* @returns {string}
*/
function doGetMsg_390( intPageIndex, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':390," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_392( intUpdateRepublishTime, strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':392," +
...
* @returns {string}
*/
function doGetMsg_500( intOrderFromAreaID, intOrderToAreaID, intPageIndex, strModels) {
   return "{'GZKMSG':[{" +
       "'intMsgID':500," +
...
* @returns {string}
*/
function doGetMsg_510( floatNeedMoney, intOrderFromAreaID, intOrderToAreaID, strCycleList, strModelsList, strPublisherSysID, strRemark) {
   return "{'GZKMSG':[{" +
       "'intMsgID':510," +
...
* @returns {string}
*/
function doGetMsg_512( intJudge, intPageIndex, strPublisherSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':512," +
       "'intJudge':" + intJudge + "," + 
       "'intPageIndex':" + intPageIndex + "," + 
...
* @returns {string}
*/
function doGetMsg_520( strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':520," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_530( dateDeparture, strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':530," +
...
* @returns {string}
*/
function doGetMsg_540( intOrderType, strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':540," +
...
* @returns {string}
*/
function doGetMsg_550( intFromAreaID, intToAreaID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':550," +
       "'intFromAreaID':" + intFromAreaID + "," + 
       "'intToAreaID':" + intToAreaID + "," + 
...
* @returns {string}
*/
function doGetMsg_560( strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':560," +
       "'strInfoSysID':'" + strInfoSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_562( strInfoSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':562," +
       "'strInfoSysID':'" + strInfoSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_564( intCarTeamDriverCount, intReceiverCount, strInfoSysID, strPayOrderSysID, strSplicePhoneNum, strSpliceUserSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':564," +
...
* @returns {string}
*/
function doGetMsg_566( intReceiverCount, strInfoSysID, strPayOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':566," +
       "'intReceiverCount':" + intReceiverCount + "," + 
       "'strInfoSysID':'" + strInfoSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_570( intPageIndex, intQueryType, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':570," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'intQueryType':" + intQueryType + "," + 
...
* @returns {string}
*/
function doGetMsg_572( intPageIndex, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':572," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_574( intNeedDisatance, intPageIndex1, intPageIndex2, intQueryType, strSendSMSSysID, strSendSMSToDriverSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':574," +
...
* @returns {string}
*/
function doGetMsg_576( strSendWXSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':576," +
...
* @returns {string}
*/
function doGetMsg_600( dateDeparture, floatMaxNeedMoney, floatMinNeedMoney, intFromAreaID, intJudge, intPageIndex, intSort, intToAreaID, strPublisherSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':600," +
       "'dateDeparture':" + dateDeparture + "," + 
...
* @returns {string}
*/
function doGetMsg_602( dateDeparture, floatMaxNeedMoney, floatMinNeedMoney, intFromAreaID, intJudge, intPageIndex, intSort, intToAreaID, strPublisherSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':602," +
       "'dateDeparture':" + dateDeparture + "," + 
       "'floatMaxNeedMoney':" + floatMaxNeedMoney + "," + 
...
* @returns {string}
*/
function doGetMsg_612( dateDeparture, floatAssignCarMoney, floatNeedMoney, intOrderFromAreaID, intOrderToAreaID, strCarSysID, strPublisherSysID, strRemark) {
   return "{'GZKMSG':[{" +
       "'intMsgID':612," +
       "'dateDeparture':" + dateDeparture + "," + 
...
* @returns {string}
*/
function doGetMsg_620( strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':620," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_622( strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':622," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_630( strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':630," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_632( strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':632," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_650( floatGPSLat, floatGPSLng, intCarTeamHomeAreaID, intOrderBy, intPageIndex, strSearchContent, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':650," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_652( strCarTeamSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':652," +
...
* @returns {string}
*/
function doGetMsg_654( intHomeAreaID, strCarTeamIconRSID, strCarTeamName, strCarTeamSysID, strHomeAreaDesc, strRemark, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':654," +
...
* @returns {string}
*/
function doGetMsg_656( floatGPSLat, floatGPSLng, intPageIndex, strCarTeamSysID, strSearchContent, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':656," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_658( intPageIndex, strCarTeamSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':658," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'strCarTeamSysID':'" + strCarTeamSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_660( intPageIndex, strSearchContent, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':660," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'strSearchContent':'" + strSearchContent + "'," + 
...
* @returns {string}
*/
function doGetMsg_670( intPageIndex, strCarTeamSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':670," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'strCarTeamSysID':'" + strCarTeamSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_672( strBeinviteUserAlias, strCancelCarTeamInviteSysID, strCarTeamSysID, strCompanySysID, strDriverPhoneNumber, strFromUserSysID, strRelativesCarTeamName, strRelativesName, strToUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':672," +
...
* @returns {string}
*/
function doGetMsg_674( intAgreeStatus, strCarTeamInviteRecordSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':674," +
...
* @returns {string}
*/
function doGetMsg_676( intPageIndex, strCarTeamSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':676," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'strCarTeamSysID':'" + strCarTeamSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_678( strCarTeamSysID, strDriverUserSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':678," +
       "'strCarTeamSysID':'" + strCarTeamSysID + "'," + 
       "'strDriverUserSysID':'" + strDriverUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_680( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':680," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_682( strCarTeamAdminSysID, strCarTeamSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':682," +
...
* @returns {string}
*/
function doGetMsg_684( intAgreeStatus, strCarJoinCarTeamRecordSysID, strDriverUserSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':684," +
       "'intAgreeStatus':" + intAgreeStatus + "," + 
...
* @returns {string}
*/
function doGetMsg_686( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':686," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_688( strCarTeamSysID, strUserPayOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':688," +
       "'strCarTeamSysID':'" + strCarTeamSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_700( dateDeparture, floatMaxNeedMoney, floatMinNeedMoney, intFromAreaID, intJudge, intPageIndex, intSort, intToAreaID, strPublisherSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':700," +
       "'dateDeparture':" + dateDeparture + "," + 
       "'floatMaxNeedMoney':" + floatMaxNeedMoney + "," + 
...
* @returns {string}
*/
function doGetMsg_702( dateDeparture, floatMaxNeedMoney, floatMinNeedMoney, intFromAreaID, intJudge, intPageIndex, intSort, intToAreaID, strPublisherSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':702," +
       "'dateDeparture':" + dateDeparture + "," + 
       "'floatMaxNeedMoney':" + floatMaxNeedMoney + "," + 
...
* @returns {string}
*/
function doGetMsg_710( dateDeparture, dateTimeout, floatCarLength, floatCarWeight, floatCube, floatModels, floatMoneyGoodsAssign, floatNeedMoney, floatWeight, intCarType, intFreightType, intGreenChannel, intInsuranceType, intNumberDays, intOrderFromAreaID, intOrderToAreaID, intPackage, strGoodsName, strGoodsPhotoRsID1, strGoodsPhotoRsID2, strGoodsPhotoRsID3, strPublisherSysID, strRemark) {
   return "{'GZKMSG':[{" +
       "'intMsgID':710," +
       "'dateDeparture':" + dateDeparture + "," + 
...
* @returns {string}
*/
function doGetMsg_712( dateDeparture, dateTimeout, floatAssignCarMoney, floatNeedMoney, intOrderFromAreaID, intOrderToAreaID, strCarSysID, strPublisherSysID, strRemark) {
   return "{'GZKMSG':[{" +
       "'intMsgID':712," +
       "'dateDeparture':" + dateDeparture + "," + 
       "'dateTimeout':" + dateTimeout + "," + 
...
* @returns {string}
*/
function doGetMsg_720( strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':720," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_722( strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':722," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_730( dateCheckout, dateCreditUpdate, dateDeparture, dateTimeout, floatCube, floatModels, floatMoneyGoodsAssign, floatNeedMoney, floatWeight, inToffer, intDocumentNumber, intFreightType, intGreenChannel, intInsuranceType, intNumberDays, intOrderStatus, intPackage, intUserCreditLevel, intUserIDStatus, intUserStatusType, pmOrderFromArea, pmOrderToArea, strCheckoutRemark, strCheckoutSysID, strGoodsName, strGoodsPhotoURL1, strGoodsPhotoURL2, strGoodsPhotoURL3, strOrderSysID, strUserAlias, strUserCreditDesc, strUserIconURL, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':730," +
...
* @returns {string}
*/
function doGetMsg_732( dateCheckout, dateCreditUpdate, dateDeparture, dateTimeout, floatAssignCarMoney, floatCarLength, floatCarWeight, floatGPSLat, floatGPSLng, floatNeedMoney, inToffer, intCarAuthStatus, intDocumentNumber, intOrderStatus, intUserCreditLevel, intUserIDCardStatus, intUserStatusType, intUserType, pmOrderFromArea, pmOrderToArea, strCarPlateNumber, strCarSysID, strCheckoutRemark, strCheckoutSysID, strCompanyName, strOrderSysID, strUserAlias, strUserCreditDesc, strUserIconURL, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':732," +
       "'dateCheckout':" + dateCheckout + "," + 
       "'dateCreditUpdate':" + dateCreditUpdate + "," + 
...
* @returns {string}
*/
function doGetMsg_740( strOrderSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':740," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_742( strOrderSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':742," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_744( strCheckoutSysID, strOrderSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':744," +
       "'strCheckoutSysID':'" + strCheckoutSysID + "'," + 
       "'strOrderSysID':'" + strOrderSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_746( strCheckoutSysID, strOrderSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':746," +
       "'strCheckoutSysID':'" + strCheckoutSysID + "'," + 
       "'strOrderSysID':'" + strOrderSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_750( intAgreeStatus, strCheckoutSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':750," +
       "'intAgreeStatus':" + intAgreeStatus + "," + 
       "'strCheckoutSysID':'" + strCheckoutSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_752( intAgreeStatus, strCheckoutSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':752," +
       "'intAgreeStatus':" + intAgreeStatus + "," + 
       "'strCheckoutSysID':'" + strCheckoutSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_800( intOperationType, strBookmarkSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':800," +
...
* @returns {string}
*/
function doGetMsg_802( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':802," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_850( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':850," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_860( floatGPSLat, floatGPSLng, floatMoneyPay, intBuyMonth, intBuyNumber, intUsePayReason, intUsePayType, strAboutOrderSysID, strCarTeamSysID, strUserPayPasscode, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':860," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_862( floatMoneyPay, intUserPayUpdateStatus, strCarTeamSysID, strUserPayOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':862," +
       "'floatMoneyPay':" + floatMoneyPay + "," + 
...
* @returns {string}
*/
function doGetMsg_866( floatGPSLat, floatGPSLng, floatMoney, intUsePayType, strCheckoutAccount, strCheckoutAccountName, strSMSCode, strUserPayPasscode, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':866," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_870( floatMoneyCarAssign, floatMoneyGoodsAssign, floatMoneyInsurance, floatMoneyShip, intCarrierDriver, intInsuranceBuyUser, intPayType) {
   return "{'GZKMSG':[{" +
       "'intMsgID':870," +
...
* @returns {string}
*/
function doGetMsg_872( floatPayMoney, strPayDesc, strPayIPAddress, strPayOrderID, strPayTitle) {
   return "{'GZKMSG':[{" +
       "'intMsgID':872," +
...
* @returns {string}
*/
function doGetMsg_874( floatPrePayMoney, intUsePayReason, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':874," +
...
* @returns {string}
*/
function doGetMsg_880( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':880," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_882( intPageIndex, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':882," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_884( intPageIndex, intQueryCouponType, intQueryUserCouponStatus, strQueryUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':884," +
       "'intPageIndex':" + intPageIndex + "," + 
...
* @returns {string}
*/
function doGetMsg_900( strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':900," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_902( strOrderSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':902," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_904( strOrderSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':904," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_906( strOrderSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':906," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_910( floatAssignCarMoney, strCarSysID, strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':910," +
       "'floatAssignCarMoney':" + floatAssignCarMoney + "," + 
       "'strCarSysID':'" + strCarSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_912( floatCube, floatModels, floatWeight, intFreightType, intGreenChannel, intNumberDays, intPackage, strGoodsName, strGoodsPhotoRsID1, strGoodsPhotoRsID2, strGoodsPhotoRsID3, strOrderSysID, strPacketDesc, strShipperOrderRemark) {
   return "{'GZKMSG':[{" +
       "'intMsgID':912," +
       "'floatCube':" + floatCube + "," + 
       "'floatModels':" + floatModels + "," + 
...
* @returns {string}
*/
function doGetMsg_914( dateDeparture, intNeedQRConfirm, intOrderFromAreaID, intOrderToAreaID, strFromAreaDetail, strOrderSysID, strReceiverName, strReceiverPhoneNumber, strSenderName, strSenderPhoneNumber, strToAreaDetail) {
   return "{'GZKMSG':[{" +
       "'intMsgID':914," +
       "'dateDeparture':" + dateDeparture + "," + 
...
* @returns {string}
*/
function doGetMsg_916( floatAssignCarMoney, floatAssignGoodsMoney, floatMoneyDeposit, floatMoneyFull, floatMoneyPrepaid, intInsuranceType, intPaymentMethod, strInsuranceBuyUserSysID, strOrderSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':916," +
       "'floatAssignCarMoney':" + floatAssignCarMoney + "," + 
...
* @returns {string}
*/
function doGetMsg_920( intJudge, intPageIndex, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':920," +
       "'intJudge':" + intJudge + "," + 
       "'intPageIndex':" + intPageIndex + "," + 
...
* @returns {string}
*/
function doGetMsg_924( strOrderSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':924," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_926( strOrderSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':926," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_930( intDetermineType, intTransportOrderUserType, strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':930," +
...
* @returns {string}
*/
function doGetMsg_932( floatGPSLat, floatGPSLng, strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':932," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_934( floatGPSLat, floatGPSLng, strOrderSysID, strScanQRCode, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':934," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_936( floatGPSLat, floatGPSLng, strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':936," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_938( floatGPSLat, floatGPSLng, intCarDrivingStatus, intIsDriverEndArea, strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':938," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_940( floatGPSLat, floatGPSLng, strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':940," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_942( floatGPSLat, floatGPSLng, strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':942," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_944( floatGPSLat, floatGPSLng, strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':944," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_946( floatGPSLat, floatGPSLng, strGiveupRemark, strOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':946," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_948( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':948," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_950( intPageIndex, intQueryListTypes, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':950," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'intQueryListTypes':" + intQueryListTypes + "," + 
...
* @returns {string}
*/
function doGetMsg_952( intPageIndex, intUserType, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':952," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'intUserType':" + intUserType + "," + 
...
* @returns {string}
*/
function doGetMsg_954( floatGPSLat, floatGPSLng) {
   return "{'GZKMSG':[{" +
       "'intMsgID':954," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_956( floatGPSLat, floatGPSLng) {
   return "{'GZKMSG':[{" +
       "'intMsgID':956," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_962( strUserAlias, strUserIDCardNumber, strUserPhoneNumber, strUserRemark, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':962," +
       "'strUserAlias':'" + strUserAlias + "'," + 
       "'strUserIDCardNumber':'" + strUserIDCardNumber + "'," + 
...
* @returns {string}
*/
function doGetMsg_964( strCarSysID, strCompanySysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':964," +
       "'strCarSysID':'" + strCarSysID + "'," + 
       "'strCompanySysID':'" + strCompanySysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_966( floatGPSLat, floatGPSLng, intPageIndex, strCarPlateNumber, strCompanySysID, strPhoneNumber) {
   return "{'GZKMSG':[{" +
       "'intMsgID':966," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_968( strOrderSysID, strPopularizeRemark, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':968," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_970( strCarTeamSysID, strCompanySysID, strDriverPhoneNumber, strFromUserSysID, strRelativesCarTeamName, strRelativesName, strToUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':970," +
       "'strCarTeamSysID':'" + strCarTeamSysID + "'," + 
       "'strCompanySysID':'" + strCompanySysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_974( intPageIndex, intQueryListTypes, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':974," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'intQueryListTypes':" + intQueryListTypes + "," + 
...
* @returns {string}
*/
function doGetMsg_976( intCityID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':976," +
       "'intCityID':" + intCityID + "," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_978( intCityID, intMessageType, intPageIndex, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':978," +
       "'intCityID':" + intCityID + "," + 
...
* @returns {string}
*/
function doGetMsg_980( strOrderSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':980," +
       "'strOrderSysID':'" + strOrderSysID + "'," + 
       "'intMsgStatus':0," +
...
/**
 * 消息 2102
 * GZKMsg_2102_PolicyAboutOperation
 * 保单相关操作
 * 测试数据
 * @param intOperationType  操作类型：0：未知；1：保存；2：提交；3：删除  操作类型：0：未知；1：保存；2：提交；3：删除
 * @param selfInsuranceInfo 提交的保单字段结构体 提交的保单字段结构体
 * @param selfUserInsuranceDiscountInfo 用户保险优惠信息结构体 用户保险优惠信息结构体
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2102( intOperationType, selfInsuranceInfo, selfUserInsuranceDiscountInfo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2102," +
        "'intOperationType':" + intOperationType + "," +
        "'selfInsuranceInfo':" + selfInsuranceInfo + "," +
        "'selfUserInsuranceDiscountInfo':" + selfUserInsuranceDiscountInfo + "," +
        "'strUserSysID':'" + strUserSysID + "'," +
        "'intMsgStatus':0," +
        "'strMsgDesc':''" +
        "}],'GZKMSGVer':2}";
...
/**
 * 消息 2104
 * GZKMsg_2104_PolicySituationOfPaymentAfter
 * 付款后保单出单
 * 测试数据
 * @param channelOrderNo 渠道订单号 渠道订单号
 * @param floatCouponAmount 优惠券面值 优惠券面值
 * @param strGetCouponSysID 领取优惠券系统编号 领取优惠券系统编号
 * @param strUserPayOrderSysID 付款单号 付款单号
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2104( channelOrderNo, floatCouponAmount, strGetCouponSysID, strUserPayOrderSysID, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2104," +
        "'channelOrderNo':'" + channelOrderNo + "'," +
        "'floatCouponAmount':" + floatCouponAmount + "," +
...
* @returns {string}
*/
function doGetMsg_2106( channelOrderNo, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2106," +
       "'channelOrderNo':'" + channelOrderNo + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
 ...
 * @returns {string}
 */
function doGetMsg_2108( policyNo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2108," +
        "'policyNo':'" + policyNo + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
...
/**
 * 消息 2100
 * GZKMsg_2100_GetUserAboutInsuranceInfo
 * 获取用户折扣信息
 * 测试数据
 * @param productNo 产品ID,固定值 2：普货运输；3：冷藏货运；4：生鲜果蔬 0
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
/**
 ...
 * @returns {string}
 */
function doGetMsg_2100( productNo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2100," +
        "'productNo':" + productNo + "," +
        "'strUserSysID':'" + strUserSysID + "'," +
 ...
 * @returns {string}
 */
function doGetMsg_2120( channelOrderNo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2120," +
        "'channelOrderNo':'" + channelOrderNo + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
...
* @returns {string}
*/
function doGetMsg_2112( policyNo, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2112," +
       "'policyNo':'" + policyNo + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_2116( intPageIndex, intQueryType, strPhoneNumber, strSearchContent, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2116," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'intQueryType':" + intQueryType + "," + 
...
/**
 * 消息 2122
 * GZKMsg_2122_PolicyUpdate
 * 保单修改
 * 测试数据
 * @param dateNewexpectStartTime 起运日期 起运日期
 * @param floattTransporMonery 运费价格 0=未输入  0
 * @param intNewamount 数量 数量 0
 * @param intNewdeparturePlace 起运地ID 起运地ID
 * @param intNewdestinationPlace 目的地ID 目的地ID
 * @param intNewgoodsWeight 货物重量 货物重量 0
 * @param intNewloadType 装载方式：1：集装箱；2：非集装箱；3：箱式货车 装载方式：1：集装箱；2：非集装箱；3：箱式货车 0
 * @param policyNo 保单号 保单号
 * @param strNewInsureLinkCertNo 被保险联系人证件号码 被保险联系人证件号码
 * @param strNewTrailerNo 挂车牌号 挂车牌号
 * @param strNewdeparturePlaceDesc 起运地描述 起运地描述
 * @param strNewdestinationPlaceDesc 目的地描述 目的地描述
 * @param strNewfreightNo 发票号/提单号/运单号 发票号/提单号/运单号
 * @param strNewgoodsClass 货物类型 货物类型
 * @param strNewgoodsName 货物名称 货物名称
 * @param strNewinsureLinkName 被保险联系人姓名 被保险联系人姓名
 * @param strNewpackType 包装类型 包装类型
 * @param strNewtransNo 车牌号/航班号/船名/航次 车牌号/航班号/船名/航次
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2122( dateNewexpectStartTime, floattTransporMonery, intNewamount, intNewdeparturePlace, intNewdestinationPlace, intNewgoodsWeight, intNewloadType, policyNo, strNewInsureLinkCertNo, strNewTrailerNo, strNewdeparturePlaceDesc, strNewdestinationPlaceDesc, strNewfreightNo, strNewgoodsClass, strNewgoodsName, strNewinsureLinkName, strNewpackType, strNewtransNo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2122," +
        "'dateNewexpectStartTime':" + dateNewexpectStartTime + "," +
        "'floattTransporMonery':" + floattTransporMonery + "," +
        "'intNewamount':" + intNewamount + "," +
        "'intNewdeparturePlace':" + intNewdeparturePlace + "," +
        "'intNewdestinationPlace':" + intNewdestinationPlace + "," +
        "'intNewgoodsWeight':" + intNewgoodsWeight + "," +
        "'intNewloadType':" + intNewloadType + "," +
        "'policyNo':'" + policyNo + "'," +
        "'strNewInsureLinkCertNo':'" + strNewInsureLinkCertNo + "'," +
        "'strNewTrailerNo':'" + strNewTrailerNo + "'," +
        "'strNewdeparturePlaceDesc':'" + strNewdeparturePlaceDesc + "'," +
        "'strNewdestinationPlaceDesc':'" + strNewdestinationPlaceDesc + "'," +
        "'strNewfreightNo':'" + strNewfreightNo + "'," +
        "'strNewgoodsClass':'" + strNewgoodsClass + "'," +
        "'strNewgoodsName':'" + strNewgoodsName + "'," +
        "'strNewinsureLinkName':'" + strNewinsureLinkName + "'," +
        "'strNewpackType':'" + strNewpackType + "'," +
        "'strNewtransNo':'" + strNewtransNo + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
        "'intMsgStatus':0," +
        "'strMsgDesc':''" +
        "}],'GZKMSGVer':2}";
...
* @returns {string}
*/
function doGetMsg_2136( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2136," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_2200( strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2200," +
       "'strUserSysID':'" + strUserSysID + "'," + 
       "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_2202( intPageIndex, intQueryType, strSearchContent, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2202," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'intQueryType':" + intQueryType + "," + 
...
* @returns {string}
*/
function doGetMsg_2204( strLineSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2204," +
...
* @returns {string}
*/
function doGetMsg_2206( intUrgentStopFrom, strLineSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2206," +
...
* @returns {string}
*/
function doGetMsg_2208( strGetCouponSysID, strLineSysID, strMatchIDList, strUserPayOrderSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2208," +
       "'strGetCouponSysID':'" + strGetCouponSysID + "'," + 
       "'strLineSysID':'" + strLineSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_2300( intMonitorDelayHours, intMonitorLimitHours, strMonitorPhone, strMonitorRemark, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2300," +
...
* @returns {string}
*/
function doGetMsg_2302( intPageIndex, intQueryStatus, strQueryKey, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2302," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'intQueryStatus':" + intQueryStatus + "," + 
...
* @returns {string}
*/
function doGetMsg_2304( strMonitorSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2304," +
...
* @returns {string}
*/
function doGetMsg_2306( strMonitorSysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2306," +
       "'strMonitorSysID':'" + strMonitorSysID + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_2308( intSMSType, strMonitorSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2308," +
...
* @returns {string}
*/
function doGetMsg_2320( intPageIndex, intQueryStatus, strQueryKey, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2320," +
       "'intPageIndex':" + intPageIndex + "," + 
       "'intQueryStatus':" + intQueryStatus + "," + 
...
* @returns {string}
*/
function doGetMsg_2322( strContactSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2322," +
...
* @returns {string}
*/
function doGetMsg_2326( strPhoneNumber, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2326," +
       "'strPhoneNumber':'" + strPhoneNumber + "'," + 
       "'strUserSysID':'" + strUserSysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_2328( strContactSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':2328," +
       "'strContactSysID':'" + strContactSysID + "'," + 
       "'intMsgStatus':0," +
...
/**
 * 消息 2332
 * GZKMsg_2332_ContactBookLableDetail
 * 通讯录标签详情
 * 测试中（新增加）
 * @param intPageIndex 分页索引  0
 * @param strLableSysID 通讯录标签系统编号 通讯录标签系统编号
 * @returns {string}
 */
/**
 * 消息 2332
 ...
 * @returns {string}
 */
function doGetMsg_2332( strLableSysID, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2332," +
        "'strLableSysID':'" + strLableSysID + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
        "'intMsgStatus':0," +
        "'strMsgDesc':''" +
        "}],'GZKMSGVer':2}";
...
/**
 * 消息 2418
 * GZKMsg_2418_DeleteFreightTransportRecordShare
 * 删除货运分享对象
 * 测试中（新增加）
 * @param strFreightTransportSysID 货运单系统编号 货运单系统编号
 * @param strPhoneNumber 分享的电话号码 分享的电话号码
 * @returns {string}
 */
function doGetMsg_2418( strFreightTransportSysID, strPhoneNumber) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2418," +
        "'strFreightTransportSysID':'" + strFreightTransportSysID + "'," +
        "'strPhoneNumber':'" + strPhoneNumber + "'," +
        "'intMsgStatus':0," +
        "'strMsgDesc':''" +
        "}],'GZKMSGVer':2}";
...
/**
 * 消息 2334
 * GZKMsg_2334_SaveContactBookLable
 * 保存通讯录标签
 * 测试中（新增加）
 * @param strContactSysIDList 通讯录系统编号串以（，）分隔开 通讯录系统编号串以（，）分隔开
 * @param strLableName 通讯录标签名称 通讯录标签名称
 * @param strLableSysID 通讯录标签系统编号 通讯录标签系统编号
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2334( strContactSysIDList, strLableName, strLableSysID, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2334," +
        "'strContactSysIDList':'" + strContactSysIDList + "'," +
        "'strLableName':'" + strLableName + "'," +
        "'strLableSysID':'" + strLableSysID + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
        "'intMsgStatus':0," +
        "'strMsgDesc':''" +
...
/**
 * 消息 2336
 * GZKMsg_2336_DeleteContactBookLableUser
 * 退出群标签
 * 测试中（新增加）
 * @param strLableSysID 通讯录标签系统编号 通讯录标签系统编号
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2336( strLableSysID, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2336," +
        "'strLableSysID':'" + strLableSysID + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
...
/**
 * 消息 2338
 * GZKMsg_2338_DeleteContactBookLable
 * 作废通讯录标签
 * 测试中（新增加）
 * @param strLableSysID 通讯录标签系统编号 通讯录标签系统编号
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2338( strLableSysID, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2338," +
        "'strLableSysID':'" + strLableSysID + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
...
/**
 * 消息 2412
 * GZKMsg_2412_FindFreightTransportRecordShareList
 * 货运分享对象列表List
 * 测试中（新增加）
 * @param intPageIndex 分页索引 分页索引 0
 * @param strFreightTransportSysID 货运单系统编号 货运单系统编号
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2412( intPageIndex, strFreightTransportSysID, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2412," +
        "'intPageIndex':" + intPageIndex + "," +
        "'strFreightTransportSysID':'" + strFreightTransportSysID + "'," +
...
/**
 * 消息 2404
 * GZKMsg_2404_UpdateOrAddFreightTransportOrder
 * 货运单处理
 * 测试中（新增加）
 * @param dateStart 起运时间 起运时间 new
 * @param floatAlarmMaxRH 湿度最高警报 湿度最高警报 0
 * @param floatAlarmMaxTemp 温度最高警报 温度最高警报 0
 * @param floatAlarmMinRH 湿度最低警报 湿度最低警报 0
 * @param floatAlarmMinTemp 温度最低警报 温度最低警报 0
 * @param intAlarmType 警报类型 警报类型 0
 * @param intFromAreaID 起点ID 起点ID 0
 * @param intToAreaID 终点ID 终点ID 0
 * @param strFreightTransportSysID 货运订单系统编号 货运订单系统编号
 * @param strFromAreaDesc 起点描述 起点描述
 * @param strGoodsName 货物名称 货物名称
 * @param strHDID 柜号 柜号
 * @param strRemarks 备注 备注
 * @param strToAreaDesc 终点描述 终点描述
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2404( dateStart, floatAlarmMaxRH, floatAlarmMaxTemp, floatAlarmMinRH, floatAlarmMinTemp, intAlarmType, intFromAreaID, intToAreaID, strEmergencyCall, strFreightTransportSysID, strFromAreaDesc, strGoodsName, strHDID, strRemarks, strToAreaDesc, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2404," +
        "'dateStart':" + dateStart + "," +
        "'floatAlarmMaxRH':" + floatAlarmMaxRH + "," +
        "'floatAlarmMaxTemp':" + floatAlarmMaxTemp + "," +
        "'floatAlarmMinRH':" + floatAlarmMinRH + "," +
        "'floatAlarmMinTemp':" + floatAlarmMinTemp + "," +
        "'intAlarmType':" + intAlarmType + "," +
        "'intFromAreaID':" + intFromAreaID + "," +
        "'intToAreaID':" + intToAreaID + "," +
        "'strEmergencyCall':'" + strEmergencyCall + "'," +
        "'strFreightTransportSysID':'" + strFreightTransportSysID + "'," +
        "'strFromAreaDesc':'" + strFromAreaDesc + "'," +
        "'strGoodsName':'" + strGoodsName + "'," +
        "'strHDID':'" + strHDID + "'," +
        "'strRemarks':'" + strRemarks + "'," +
        "'strToAreaDesc':'" + strToAreaDesc + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
        "'intMsgStatus':0," +
        "'strMsgDesc':''" +
        "}],'GZKMSGVer':2}";
...
/**
 * 消息 2424
 * GZKMsg_2424_FindContainerManagementList
 * 冷柜管理列表List
 * 测试中（新增加）
 * @param intPageIndex 分页索引 分页索引 0
 * @param intQueryListTypes 查询类型 0：我的冷柜；1：进行中；2：不是正在使用的; 0
 * @param strSearchContent 查询内容关键字
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2424( intPageIndex, intQueryListTypes, strSearchContent, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2424," +
        "'intPageIndex':" + intPageIndex + "," +
        "'intQueryListTypes':" + intQueryListTypes + "," +
...
/**
 * 消息 2426
 * GZKMsg_2426_GetContainerManagementDetail
 * 冷柜管理详情
 * 测试中（新增加）
 * @param strHDID 货柜系统编号 货柜系统编号
 * @returns {string}
 */
function doGetMsg_2426( strHDID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2426," +
        "'strHDID':'" + strHDID + "'," +
        "'intMsgStatus':0," +
...
/**
 * 消息 2428
 * GZKMsg_2428_PayForFreightTransport
 * HD货运单支付
 * 测试中（新增加）
 * @param strFreightTransportSysID 货运单系统编号 货运单系统编号
 * @param strUserPayOrderSysID 付款单号 付款单号
 * @returns {string}
 */
function doGetMsg_2428( strFreightTransportSysID, strUserPayOrderSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2428," +
        "'strFreightTransportSysID':'" + strFreightTransportSysID + "'," +
        "'strUserPayOrderSysID':'" + strUserPayOrderSysID + "'," +
...
/**
 * 消息 2430
 * GZKMsg_2430_FindTheLastFreightTransportOrder
 * 新建货运单时带入最后一条货运单数据
 * 测试中（新增加）
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 ...
 * @returns {string}
 */
function doGetMsg_2430( strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2430," +
        "'strUserSysID':'" + strUserSysID + "'," +
        "'intMsgStatus':0," +
...
* @returns {string}
*/
function doGetMsg_8000( intDeviceOSType, intPayReason, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':8000," +
       "'intDeviceOSType':" + intDeviceOSType + "," + 
...
* @returns {string}
*/
function doGetMsg_8010( floatCheckoutMoney, floatGPSLat, floatGPSLng, intCheckoutWay, intDeviceOSType, strCheckoutTo, strPayCode, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':8010," +
...
* @returns {string}
*/
function doGetMsg_8012( strPayCode, strPaySysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':8012," +
       "'strPayCode':'" + strPayCode + "'," + 
...
* @returns {string}
*/
function doGetMsg_8014( strPayCode, strPaySysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':8014," +
       "'strPayCode':'" + strPayCode + "'," + 
       "'strPaySysID':'" + strPaySysID + "'," + 
...
* @returns {string}
*/
function doGetMsg_8016( intIsHistory, intPageIndex, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':8016," +
...
* @returns {string}
*/
function doGetMsg_8030( floatGPSLat, floatGPSLng, floatPayMoney, intDeviceOSType, intPayReason, strAboutInfo, strPayCode, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':8030," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_8040( floatGPSLat, floatGPSLng, floatPayMoney, intDeviceOSType, intPayReason, strAboutInfo, strPayCode, strUserSysID, strWXOpenID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':8040," +
       "'floatGPSLat':" + floatGPSLat + "," + 
       "'floatGPSLng':" + floatGPSLng + "," + 
...
* @returns {string}
*/
function doGetMsg_8042( intPayEndResult, strAboutInfo, strPayOrderID, strPaySysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':8042," +
...
* @returns {string}
*/
function doGetMsg_8044( strPayOrderID, strPaySysID, strUserSysID) {
   return "{'GZKMSG':[{" +
       "'intMsgID':8044," +
       "'strPayOrderID':'" + strPayOrderID + "'," + 
       "'strPaySysID':'" + strPaySysID + "'," + 
...
/**
 * 消息 2414
 * GZKMsg_2414_FindGZKContactBookWithShareList
 * 果真快通讯录列表List（分享）
 * 测试中（新增加）
 * @param intPageIndex 分页索引 分页索引 0
 * @param intQueryListTypes 查询类型 0：果真快通讯录；1：果真快标签; 0
 * @param strSearchContent 查询内容关键字 查询内容关键字
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2414( intPageIndex, intQueryListTypes, strSearchContent, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2414," +
        "'intPageIndex':" + intPageIndex + "," +
        "'intQueryListTypes':" + intQueryListTypes + "," +
...
/**
 * 消息 2416
 * GZKMsg_2416_SaveFreightTransportRecordShare
 * 保存货运分享对象
 * 测试中（新增加）
 * @param strFreightTransportSysID 货运单系统编号 货运单系统编号
 * @param strPhoneNumberList 分享的电话号码串以（，）分隔开 分享的电话号码串以（，）分隔开
 * @returns {string}
 */
function doGetMsg_2416( strFreightTransportSysID, strPhoneNumberList) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2416," +
        "'strFreightTransportSysID':'" + strFreightTransportSysID + "'," +
        "'strPhoneNumberList':'" + strPhoneNumberList + "'," +
        "'intMsgStatus':0," +
        "'strMsgDesc':''" +
        "}],'GZKMSGVer':2}";
}
...
/**
 * 消息 2330
 * GZKMsg_2330_FindContactBookAllLableList
 * 通讯录全部标签List
 * 测试中（新增加）
 * @param intPageIndex 分页索引  0
 * @param strQueryKey 查询关键字 如标签名称，姓名，电话等
 * @param strUserSysID 用户的系统编号
 * @returns {string}
 */
function doGetMsg_2330( intPageIndex, strQueryKey, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2330," +
        "'intPageIndex':" + intPageIndex + "," +
        "'strQueryKey':'" + strQueryKey + "'," +
...
/**
 * 消息 2400
 * GZKMsg_2400_ContainerRecordList
 * 货柜列表
 * 测试中（新增加）
 * @param intPageIndex 分页索引 分页索引 0
 * @param intQueryListTypes 查询类型 0：进行中；1：全部记录；2：历史记录; 0
 * @param strSearchContent 查询内容关键字
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2400( intPageIndex, intQueryListTypes, strSearchContent, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2400," +
        "'intPageIndex':" + intPageIndex + "," +
        "'intQueryListTypes':" + intQueryListTypes + "," +
...
/**
 * 消息 2402
 * GZKMsg_2402_FreightTransportOrderDetail
 * 货运单详情
 * 测试中（新增加）
 * @param strFreightTransportSysID 货运订单系统编号 货运订单系统编号
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2402( strFreightTransportSysID, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2402," +
        "'strFreightTransportSysID':'" + strFreightTransportSysID + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
 ...
 * @returns {string}
 */
function doGetMsg_2420( strHDID, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2420," +
        "'strHDID':'" + strHDID + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
...
/**
 * 消息 2410
 * GZKMsg_2410_EndFreightTransportOrder
 * 结束货运记录
 * 测试中（新增加）
 * @param strFreightTransportSysID 货运单系统编号 货运单系统编号
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2410( strFreightTransportSysID, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2410," +
        "'strFreightTransportSysID':'" + strFreightTransportSysID + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
...
/**
 * 消息 2406
 * GZKMsg_2406_FreightTransportData
 * 查看货运数据
 * 测试中（新增加）
 * @param strFreightTransportSysID 货运订单系统编号 货运订单系统编号
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2406( strFreightTransportSysID, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2406," +
        "'strFreightTransportSysID':'" + strFreightTransportSysID + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
...
/**
 * 消息 2408
 * GZKMsg_2408_FreightTransportDataStatistics
 * 查看货运数据统计
 * 测试中（新增加）
 * @param strFreightTransportSysID 货运订单系统编号 货运订单系统编号
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2408( strFreightTransportSysID, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2408," +
        "'strFreightTransportSysID':'" + strFreightTransportSysID + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
...
/**
 * 消息 2500
 * GZKMsg_2500_GetUserAboutInsuranceInfoToTwo
 * 获取用户与保险相关的信息 修改2.0
 * 测试中（新增加）
 * @param productNo 产品ID,固定值 2：普货运输；3：冷藏货运；4：生鲜果蔬 0
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2500( productNo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2500," +
        "'productNo':" + productNo + "," +
        "'strUserSysID':'" + strUserSysID + "'," +
...
/**
 * 消息 2502
 * GZKMsg_2502_PolicyAboutOperationToTwo
 * 保单相关操作_修改2.0
 * 测试中（新增加）
 * @param intOperationType  操作类型：0：未知；1：保存；2：提交；3：删除  操作类型：0：未知；1：保存；2：提交；3：删除
 * @param selfInsuranceInfo 提交的保单字段结构体 提交的保单字段结构体
 ...
 * @returns {string}
 */
function doGetMsg_2502( intOperationType, selfInsuranceInfo, selfUserInsuranceDiscountInfo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2502," +
        "'intOperationType':" + intOperationType + "," +
        "'selfInsuranceInfo':" + selfInsuranceInfo + "," +
...
/**
 * 消息 2504
 * GZKMsg_2504_PolicySituationOfPaymentAfterToTwo
 * 付款后保单出单_修改2.0
 * 测试中（新增加）
 * @param channelOrderNo 渠道订单号 渠道订单号
 * @param floatCouponAmount 优惠券面值 优惠券面值
 ...
 * @returns {string}
 */
function doGetMsg_2504( channelOrderNo, floatCouponAmount, strGetCouponSysID, strUserPayOrderSysID, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2504," +
        "'channelOrderNo':'" + channelOrderNo + "'," +
        "'floatCouponAmount':" + floatCouponAmount + "," +
...
/**
 * 消息 2506
 * GZKMsg_2506_GetPolicyDetailInfoToTwo
 * 获取保单详情_修改2.0
 * 测试中（新增加）
 * @param channelOrderNo 渠道订单号 渠道订单号
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2506( channelOrderNo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2506," +
        "'channelOrderNo':'" + channelOrderNo + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
 ...
 * @returns {string}
 */
function doGetMsg_2508( policyNo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2508," +
        "'policyNo':'" + policyNo + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
...
/**
 * 消息 2510
 * GZKMsg_2510_SubmitClaimApplyToTwo
 * 提交理赔申请_修改2.0
 * 测试中（新增加）
 * @param intOperationType 操作类型：0：未知；1：保存草稿；2：申请理赔 操作类型：0：未知；1：保存草稿；2：申请理赔
 * @param policyNo 保单号 保单号
 * @param selfInsuranceClaimsInfo 理赔字段 理赔字段
 * @param strUserSysID 操作用户系统编号 操作用户系统编号
 * @returns {string}
 */
function doGetMsg_2510( intOperationType, policyNo, selfInsuranceClaimsInfo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2510," +
        "'intOperationType':" + intOperationType + "," +
        "'policyNo':'" + policyNo + "'," +
        "'selfInsuranceClaimsInfo':" + selfInsuranceClaimsInfo + "," +
        "'strUserSysID':'" + strUserSysID + "'," +
        "'intMsgStatus':0," +
        "'strMsgDesc':''" +
        "}],'GZKMSGVer':2}";
...
/**
 * 消息 2512
 * GZKMsg_2512_GetClaimsDetailInfoToTwo
 * 获取理赔详情_修改2.0
 * 测试中（新增加）
 * @param policyNo 保单号 保单号
 * @param strUserSysID 操作用户系统编号 操作用户系统编号
 * @returns {string}
 */
function doGetMsg_2512( policyNo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2512," +
        "'policyNo':'" + policyNo + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
...
/**
 * 消息 2516
 * GZKMsg_2516_GetPolicyListToTwo
 * 获取保单列表_修改2.0
 * 测试中（新增加）
 * @param intPageIndex 分页索引  0
 * @param intQueryType 查询类型：0：全部；1：进行中；2：历史；3：理赔；4：草稿；5：待付款 查询类型：0：全部；1：进行中；2：历史；3：理赔；4：草稿；5：待付款 0
 ...
 * @returns {string}
 */
function doGetMsg_2516( intPageIndex, intQueryType, strPhoneNumber, strSearchContent, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2516," +
        "'intPageIndex':" + intPageIndex + "," +
        "'intQueryType':" + intQueryType + "," +
...
/**
 * 消息 2520
 * GZKMsg_2520_CancelPolicyOrderToTwo
 * 取消保单下单_修改2.0
 * 测试中（新增加）
 * @param channelOrderNo 渠道订单号 渠道订单号
 * @param strUserSysID 用户系统编号 用户系统编号
 * @returns {string}
 */
function doGetMsg_2520( channelOrderNo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2520," +
        "'channelOrderNo':'" + channelOrderNo + "'," +
        "'strUserSysID':'" + strUserSysID + "'," +
 ...
 * @returns {string}
 */
function doGetMsg_2522( dateNewexpectStartTime, floattTransporMonery, intNewamount, intNewdeparturePlace, intNewdestinationPlace, intNewgoodsWeight, intNewloadType, policyNo, strNewInsureLinkCertNo, strNewTrailerNo, strNewdeparturePlaceDesc, strNewdestinationPlaceDesc, strNewfreightNo, strNewgoodsClass, strNewgoodsName, strNewinsureLinkName, strNewpackType, strNewtransNo, strUserSysID) {
    return "{'GZKMSG':[{" +
        "'intMsgID':2522," +
        "'dateNewexpectStartTime':" + dateNewexpectStartTime + "," +
        "'floattTransporMonery':" + floattTransporMonery + "," +
